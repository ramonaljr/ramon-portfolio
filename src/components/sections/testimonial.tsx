    ...
    <section className="py-40 relative overflow-hidden bg-surface-container-low">
      ...
      <div className="max-w-4xl mx-auto px-8 relative z-10 text-center">
        <FadeIn>
          <MaterialIcon
            name="format_quote"
            className="text-6xl text-primary-fixed-dim mb-8"
          />
        </FadeIn>

        <FadeIn delay={0.2}>
          <blockquote className="text-3xl md:text-5xl font-headline font-medium text-on-surface leading-tight mb-12">
        ...
        <FadeIn delay={0.5}>
          <div className="flex flex-col items-center">
            <div className="w-16 h-16 rounded-full overflow-hidden mb-4 border-2 border-white shadow-lg relative">
              <Image
            ...
            <h5 className="text-xl font-headline font-bold">Julian Thorne</h5>
